...
contextBridge.exposeInMainWorld("strideterm", {
  ...
  listAzurePipelines: (payload) => ipcRenderer.invoke("azure:pipelines:list", payload),
  listAzurePipelineRuns: (payload) => ipcRenderer.invoke("azure:pipelines:runs", payload),
  getAzurePipelineRunSeed: (payload) => ipcRenderer.invoke("azure:pipelines:run-seed", payload),
  getAzurePipelineRunParameters: (payload) => ipcRenderer.invoke("azure:pipelines:run-parameters", payload),
  getAzurePipelineRefs: (payload) => ipcRenderer.invoke("azure:pipelines:refs", payload),
  getAzurePipelineCommits: (payload) => ipcRenderer.invoke("azure:pipelines:commits", payload),
  runAzurePipeline: (payload) => ipcRenderer.invoke("azure:pipelines:run", payload),
  ...
  resendTaskInstruction: (payload) => ipcRenderer.invoke("task:resend-instruction", payload),
  ...
  gitListStashes: (payload) => ipcRenderer.invoke("git:stash-list", payload),
  gitStashFiles: (payload) => ipcRenderer.invoke("git:stash-files", payload),
  gitStashFileDiff: (payload) => ipcRenderer.invoke("git:stash-file-diff", payload),
  gitStashApply: (payload) => ipcRenderer.invoke("git:stash-apply", payload),
  gitStashDrop: (payload) => ipcRenderer.invoke("git:stash-drop", payload),
  gitStashBranch: (payload) => ipcRenderer.invoke("git:stash-branch", payload),
  gitStashExport: (payload) => ipcRenderer.invoke("git:stash-export", payload),
  gitStashImport: (payload) => ipcRenderer.invoke("git:stash-import", payload),
  ...
  gitDeleteRemoteBranch: (payload) => ipcRenderer.invoke("git:delete-remote-branch", payload),
  gitRenameBranch: (payload) => ipcRenderer.invoke("git:rename-branch", payload),
  gitCheckoutRemoteBranch: (payload) => ipcRenderer.invoke("git:checkout-remote-branch", payload),
  gitLogGraph: (payload) => ipcRenderer.invoke("git:log-graph", payload),
  gitSkipCommit: (payload) => ipcRenderer.invoke("git:skip-commit", payload),
  gitListConflicts: (payload) => ipcRenderer.invoke("git:list-conflicts", payload),
  ...
  deleteProfile: (profileId, options) => ipcRenderer.invoke("profile:delete", profileId, options),
