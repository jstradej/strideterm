<template>
  <div class="dialog" style="width:min(540px,100%);">
    ...
    <div style="display:grid;gap:8px;margin-top:14px;">
      <button class="project" style="--accent:#ffa424;border:1px solid var(--border);cursor:pointer;" @click="emit('pick-empty')">
...
const pluginsWithTemplates = computed(() =>
  props.plugins.filter((p) => p.workspaceDefaults && !p.error),
);
</script>
