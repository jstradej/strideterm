/**
 * Regression coverage: GitHubConnectionDialog's browseReviewRoot used to call
...
import GitHubConnectionDialog from "./GitHubConnectionDialog.vue";
...
describe("GitHubConnectionDialog — browseReviewRoot", () => {
  test("a rejecting browseDirectory shows an error notification instead of throwing", async () => {
    ...
    const wrapper = mount(GitHubConnectionDialog, {
